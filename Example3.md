...
The code and the Simulink model are in the [Example3_Codes_and Model](Example3_Codes_and_Model) folder. The workflow of the code and the model is the same as that of Example1, so no explanation is introduced. If confused, refer to Example1 for detailed stepwise explanation.
